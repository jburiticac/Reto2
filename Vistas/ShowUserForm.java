...
public class ShowUserForm extends javax.swing.JDialog {
   ...
   public void recibeDatos(int idEmp, String nombreEmp,String apellidos, String document, String correo){
       ...
       txtTipoDocumento.setText(document);
   ...
   public void actualizarEmpleado(){
         ...
         if(nombre.isEmpty()){
           JOptionPane.showMessageDialog(this,"el nombre es un campo requerido","",JOptionPane.WARNING_MESSAGE);
         ...
         String query ="UPDATE `empleados` SET `nombreEmp`='"+ nombre +"',`apellidos`='" + apellidos + "',`correo`='"+correo + "'"
             ...
             try {
                 connection= conexion.getCConnection();
       ...
       String query="DELETE FROM `empleados` WHERE idEmp ="+idEmp+";";
        try {
             ...
             JOptionPane.showMessageDialog(this, "El usuario ha sido eliminado");
                 ...
                 JOptionPane.showMessageDialog(this,"no se pudo eliminar el emplead","",JOptionPane.ERROR_MESSAGE);
             }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtTipoDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
